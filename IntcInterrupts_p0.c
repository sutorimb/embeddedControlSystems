...
nofralloc
   ...
   /* IVOR4 is for external interrupts. On the MPC551x, the IVORxx registers
    * are hard-wired to fixed addresses (see ivor_branch_table_p0.c. We've 
