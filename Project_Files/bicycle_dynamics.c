 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Wed Nov 30 13:20:28 2016
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME bicycle_dynamics
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          4
/* Input Port  0 */
#define IN_PORT_0_NAME      Fd
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    bicycle_dynamics_Outputs_wrapper(Fd, delta, u, psi, x_dot, y_dot, psi_dot, u_dot);
