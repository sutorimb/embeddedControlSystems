...
MODEL           = Final_project
MODULES         = Final_project_data.c FlexPWM_564xL_library.c adc0_config.c adc_564xl_library.c adc_init.c adc_trigger_init.c bicycle_dynamics.c bicycle_dynamics_wrapper.c calc_lead_vehicle.c calc_lead_vehicle_wrapper.c eTimer_564xL_library.c flexcan_564xl_library.c flexpwm_init.c freemaster_MPC56xx.c freemaster_appcmd.c freemaster_protocol.c freemaster_rec.c freemaster_scope.c freemaster_serial.c freemaster_sfio.c freemaster_tsa.c gpio_564xl_library.c intc_init.c intc_sw_vectable.c linflex_init.c linflex_siu_init.c rappid_main.c rappid_utils.c romcopy.c rtGetInf.c rtGetNaN.c rt_nonfinite.c siu_init.c sys_init.c sysclk_init.c 
...
MAKECMD             = "C:\Program Files\MATLAB\R2015b\bin\win64\gmake"
HOST                = PC
BUILD               = yes
...
ADD_INCLUDES = \
	-I\\engin-labs.m.storage.umich.edu\sutorimb\EECS461\Project_Files\Final_project_rappid_rtw \
	-I\\engin-labs.m.storage.umich.edu\sutorimb\EECS461\Project_Files \
	-IC:\MCToolbox\rappid564xl\UofMBlocks2\UofM_blocks\blocks\VehicleSim \
...
$(LIB_TEMP)/%.o: C:\MCToolbox\rappid564xl\UofMBlocks2\UofM_blocks\blocks\Conversions/%.c
	@echo ### "C:\MCToolbox\rappid564xl\UofMBlocks2\UofM_blocks\blocks\Conversions\$*.c"
	@$(COMPILE_TOOL) $(COMPILE_TOOL_OPTS) $(CFLAGS) -o $@ -c $<
$(PLIB_TEMP)/%.o: C:\MCToolbox\rappid564xl\UofMBlocks2\UofM_blocks\blocks\Conversions/%.c
	@echo ### "C:\MCToolbox\rappid564xl\UofMBlocks2\UofM_blocks\blocks\Conversions\$*.c"
	@$(COMPILE_TOOL) $(COMPILE_TOOL_OPTS) $(CFLAGS) -o $@ -c $<


$(LIB_TEMP)/%.o: C:\MCToolbox\rappid564xl\UofMBlocks2\UofM_blocks\blocks\VehicleSim/%.c
	@echo ### "C:\MCToolbox\rappid564xl\UofMBlocks2\UofM_blocks\blocks\VehicleSim\$*.c"
	@$(COMPILE_TOOL) $(COMPILE_TOOL_OPTS) $(CFLAGS) -o $@ -c $<
$(PLIB_TEMP)/%.o: C:\MCToolbox\rappid564xl\UofMBlocks2\UofM_blocks\blocks\VehicleSim/%.c
	@echo ### "C:\MCToolbox\rappid564xl\UofMBlocks2\UofM_blocks\blocks\VehicleSim\$*.c"
	@$(COMPILE_TOOL) $(COMPILE_TOOL_OPTS) $(CFLAGS) -o $@ -c $<
...
$(LIB_TEMP)/%.o: \\engin-labs.m.storage.umich.edu\sutorimb\windat.V2\Desktop\Project_Files/%.c
	@echo ### "\\engin-labs.m.storage.umich.edu\sutorimb\windat.V2\Desktop\Project_Files\$*.c"
	@$(COMPILE_TOOL) $(COMPILE_TOOL_OPTS) $(CFLAGS) -o $@ -c $<
$(PLIB_TEMP)/%.o: \\engin-labs.m.storage.umich.edu\sutorimb\windat.V2\Desktop\Project_Files/%.c
	@echo ### "\\engin-labs.m.storage.umich.edu\sutorimb\windat.V2\Desktop\Project_Files\$*.c"
	@$(COMPILE_TOOL) $(COMPILE_TOOL_OPTS) $(CFLAGS) -o $@ -c $<
