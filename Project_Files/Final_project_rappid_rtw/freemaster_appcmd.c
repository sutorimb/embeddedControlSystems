...
FMSTR_BPTR FMSTR_GetAppCmdRespData(FMSTR_BPTR pMessageIO)
{
  ...
  if ((((FMSTR_U16)nDataOffset) + nDataLen) > (FMSTR_SIZE8)
  ...
  /* copy to buffer */
  {
    FMSTR_ADDR appCmdBuffAddr;
    FMSTR_ARR2ADDR(appCmdBuffAddr, pcm_pAppCmdBuff);
    pResponse = FMSTR_CopyToBuffer(pResponse, appCmdBuffAddr, (FMSTR_SIZE8)
      nDataLen);
  }
 ...
 *
 ******************************************************************************/
void FMSTR_AppCmdSetResponseData(FMSTR_ADDR nResultDataAddr, FMSTR_SIZE
  nResultDataLen)
{
...
void FMSTR_AppCmdSetResponseData(FMSTR_ADDR pResultData, FMSTR_SIZE
  nResultDataLen)
{
